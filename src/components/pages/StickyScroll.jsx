...
import stu3 from "../../assets/Images/stu3.webp";
import stu4 from "../../assets/Images/stu4.png";
    ...
    <ReactLenis root>
      <main className="bg-white">
        <div className="wrapper">
          ...
          <section className="bg-slate-700 text-black grid place-content-center h-screen sticky top-0 rounded-tr-2xl rounded-tl-2xl overflow-hidden">
