...
const Testimonial = () => {
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-r from-[#e0f7ff] via-[#dfe7fd] to-[#e0f7ff]">
      {/* Animated Floating Shapes */}
      <div className="absolute inset-0 z-0">
        <div className="bg-[#027FC3] opacity-50 rounded-full blur-3xl w-48 h-48 sm:w-72 sm:h-72 lg:w-96 lg:h-96 absolute -top-10 -left-10 sm:-top-20 sm:-left-20 animate-pulse"></div>
        <div className="bg-[#bcbbbb] opacity-50 rounded-full blur-3xl w-36 h-36 sm:w-56 sm:h-56 lg:w-72 lg:h-72 absolute top-20 left-10 sm:top-40 sm:left-20 animate-bounce"></div>
        <div className="bg-[#2B4184] opacity-50 rounded-full blur-3xl w-40 h-40 sm:w-60 sm:h-60 lg:w-80 lg:h-80 absolute bottom-5 right-10 sm:bottom-10 sm:right-20 animate-pulse"></div>
      </div>

      {/* Testimonial Content */}
      <div className="relative z-10">
        <div className="relative flex justify-center items-center h-20 sm:h-28 mb-2">
          <ScrollElement
            viewport={{ amount: 0.5, margin: '0px 0px 0px 0px' }}
            className="text-3xl sm:text-5xl text-center py-4"
          >
            <h1 className="text-4xl sm:text-4xl lg:text-5xl font-bold z-10 relative">
              <span className="text-[#284587]">Testimonials</span>
              <svg
        ...
        <section className="pb-10 sm:pb-20 pt-10 sm:pt-20">
          <div className="mx-auto text-black max-w-4xl">
            <Swiper slidesPerView={1} ref={sliderRef}>
              <SwiperSlide>
                <SingleTestimonial
                  ...
                  reviewAlt="Nitin Arora"
                  details="Our college provides IBM certifications in collaboration with ISTE and CSI, which is helping the students to develop their skills. The facilities available at CT are extra-ordinary."
                  name="CT Group"
                  position="Faculty"
                />
              </SwiperSlide>
              ...
              <div className="absolute left-0 right-0 z-10 flex items-center justify-center gap-5 bottom-5 sm:bottom-0">
                <div
                  className="prev-arrow cursor-pointer text-black"
                  onClick={handlePrev}
                >
                  <button className="flex h-10 w-10 sm:h-12 sm:w-12 lg:h-14 lg:w-14 items-center justify-center rounded-full border border-stroke bg-white text-dark transition-all hover:border-transparent hover:drop-shadow-testimonial">
                    <svg
                      width="20"
                      height="21"
                      viewBox="0 0 20 21"
                ...
                <div
                  className="next-arrow cursor-pointer text-black"
                  onClick={handleNext}
                >
                  <button className="flex h-10 w-10 sm:h-12 sm:w-12 lg:h-14 lg:w-14 items-center justify-center rounded-full border border-stroke bg-white text-dark transition-all hover:border-transparent hover:drop-shadow-testimonial">
                    <svg
